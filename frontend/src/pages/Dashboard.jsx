...
export default function Dashboard() {
  ...
  // Effects should come after all other hooks
  useEffect(() => {
    fetchDashboardData();
  ...
  // Destructure filteredItems for cleaner JSX
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
     ...
     {/* Property Map Modal - Use Suspense for lazy loading */}
     {showMap && (
     ...
     {/* Property Details Modal - Use Suspense for lazy loading */}
     {selectedProperty && (
       <div className="fixed inset-0 bg-black bg-opacity-75 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
