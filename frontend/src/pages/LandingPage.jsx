          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-blue-100 hover:text-blue-600 transition-colors mx-auto">
