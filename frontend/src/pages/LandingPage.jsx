              ...
              <div className="flex-1 p-4">
                <div className="aspect-video rounded-lg overflow-hidden shadow-lg">
                  <video
                    ...
                    poster="/preview.png" // Optional: remove if you don't have one
                  >
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className={`bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform ${isVisible.features ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{transitionDelay: '500ms'}}>
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span className="ml-2 text-sm text-gray-600">Address and zip code search</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 rounded-full bg-blue-100 flex items-center justify-center mt-0.5">
                    <svg className="h-3 w-3 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className={`bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform ${isVisible.features ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{transitionDelay: '1100ms'}}>
              <div className="w-16 h-16 mb-6 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl flex items-center justify-center">
                <SquareCode className="h-7 w-7 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-4">AI Integration</h3>
              <p className="text-gray-600 mb-4">
                Integrated with LLMs for detailed wealth estimations and report generation, enhancing accuracy and insights.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 rounded-full bg-blue-100 flex items-center justify-center mt-0.5">
                  ...
                  <span className="ml-2 text-sm text-gray-600">Automated Wealth Analysis</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 rounded-full bg-blue-100 flex items-center justify-center mt-0.5">
                    <svg className="h-3 w-3 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="ml-2 text-sm text-gray-600">Automated Report Generation</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 rounded-full bg-blue-100 flex items-center justify-center mt-0.5">
                    <svg className="h-3 w-3 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="ml-2 text-sm text-gray-600">Automated Data Insights</span>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className={`bg-white rounded-2xl p-8 shadow-md transition-all duration-700 ${isVisible.tech ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{transitionDelay: '1100ms'}}>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start">
                  ...
                  <span className="ml-2 text-sm text-gray-600">Maps & Street View</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 rounded-full bg-blue-100 flex items-center justify-center mt-0.5">
                    <svg className="h-3 w-3 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/dhruval30/fueled-wealth-map" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-blue-100 hover:text-blue-600 transition-colors mx-auto">
